...
ALTER TABLE `orders` ADD CONSTRAINT `orders_style_id_styles_id_fk` FOREIGN KEY (`style_id`) REFERENCES `styles`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `orders` ADD CONSTRAINT `orders_service_key_services_key_fk` FOREIGN KEY (`service_key`) REFERENCES `services`(`key`) ON DELETE no action ON UPDATE no action;
...
ALTER TABLE `gallery` ADD CONSTRAINT `gallery_style_id_styles_id_fk` FOREIGN KEY (`style_id`) REFERENCES `styles`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `locations` ADD CONSTRAINT `locations_service_key_services_key_fk` FOREIGN KEY (`service_key`) REFERENCES `services`(`key`) ON DELETE cascade ON UPDATE no action;
